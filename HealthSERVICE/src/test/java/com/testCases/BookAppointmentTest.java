...
import com.testCases.BookAppointmentTest;
...
public class BookAppointmentTest extends Base {
	
public Actions actions;
	
	private Logger log = LogManager.getLogger(BookAppointmentTest.class.getName());
	...
	@Test(description ="Verify that user can Book Appointment")
